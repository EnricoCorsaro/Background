...
def background_mpd(catalog_id,star_id,subdir,root_path=None):
    ...
    terminal_labels = [r'White Noise',
                       ...
                       r'Amplitude_Gran',
                       r'Frequency_Gran',
                       r'Ampltidue_Gran (original)',
                       r'Frequency_Gran (original)',
                       r'Height Gaussian',
                       r'nu_max',
                       r'Sigma_envelope']
...
def get_background_params(catalog_id,star_id,results_dir):
    ...
    estimates for each free parameter of the model. The function works even if the summary file
    is not available, by computing the parameter estimates through the sampling evolution and posterior
    information.
...
def print_background_params(catalog_id,star_id,results_dir,root_path=None):
    """
