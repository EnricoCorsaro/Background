...
// NoGaussianBackgroundModel::NoGaussianBackgroundModel()
//
// PURPOSE: 
...
NoGaussianBackgroundModel::NoGaussianBackgroundModel(const RefArrayXd covariates, const string inputNyquistFrequencyFileName)
...
// NoGaussianBackgroundModel::predict()
//
// PURPOSE:
...
void NoGaussianBackgroundModel::predict(RefArrayXd predictions, RefArrayXd const modelParameters)
{
