...
int main(int argc, char *argv[])
{
    ...
    parametersMinima(0) = 13.0;                  // Flat noise level
    parametersMaxima(0) = 20.0;
    
    parametersMinima(1) = 160.;                  // Noise Amplitude 1  
    parametersMaxima(1) = 250.;
    parametersMinima(2) = 10.;                   // Noise Frequency 1
    parametersMaxima(2) = 20.;    
    
    parametersMinima(3) = 150.;                  // Noise Amplitude 2
    parametersMaxima(3) = 200.;
    parametersMinima(4) = 20.;                   // Noise Frequency 2
    parametersMaxima(4) = 50.;    
    
    parametersMinima(5) = 190.;                  // Noise Amplitude 3    
    parametersMaxima(5) = 230.;
    parametersMinima(6) = 90.;                   // Noise Frequency 3    
    parametersMaxima(6) = 120.;    
   
    parametersMinima(7) = 650.;                   // Oscillation Height
    parametersMaxima(7) = 750.;
    parametersMinima(8) = 110.;                  // Oscillation nuMax
    parametersMaxima(8) = 125.;
    parametersMinima(9) = 8.;                   // Oscillation sigma
    parametersMaxima(9) = 15.;
    ...
    double shrinkingRate = 0.04;                     // Exponent for remaining prior mass in ellipsoid enlargement fraction.
