...
// SimpleBackgroundModel::SimpleBackgroundModel()
//
// PURPOSE: 
...
SimpleBackgroundModel::SimpleBackgroundModel(const RefArrayXd covariates, const string inputNyquistFrequencyFileName)
...
void SimpleBackgroundModel::predict(RefArrayXd predictions, RefArrayXd const modelParameters)
{
